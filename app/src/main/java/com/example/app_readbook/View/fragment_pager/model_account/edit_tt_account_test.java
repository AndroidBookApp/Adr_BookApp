...
public class edit_tt_account_test extends AppCompatActivity {
    private static final int MY_REQUEST_CODE = 10;
    public static final String TAG = edit_tt_account_test.class.getName();
        ...
        updateMemberViewModel.getUpdate().observe(this, new Observer<login>() {
            ...
            public void onChanged(login login) {
                if (login != null) {
                    ...
                    Toast.makeText(edit_tt_account_test.this, "Update Thành Công", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                    loadUser();

                } else {
                    Toast.makeText(edit_tt_account_test.this, "Update Không Thành Công", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }
        });
    ...
    private void callAPIUPDATE() {
        progressDialog.show();
        String strRealPath = RealPathUtil.getRealPath(edit_tt_account_test.this, mUri);
        String strRealPath1 = RealPathUtil.getRealPath(edit_tt_account_test.this, mUri1);
        ...
        Call<String> loginCall = apiInterface.UploadPhoto(body, body1);
        loginCall.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                if (response != null) {
                    if (response.isSuccessful()) {
                        String anhbia = response.body();
                        String anhdaidien = response.body();
                        Log.e("AAA", anhbia);
                        Log.e("AAA", anhdaidien);
                        if (anhdaidien.length() > 0 || anhbia.length() > 0) {
                            ...
                            updateMemberViewModel.iniUpdateMember(idmember,
                                    ...
                                    ApiService.base_URL + "images/" + anhbia);
                        }
                    }
                }
            }
            ...
            public void onFailure(Call<String> call, Throwable t) {
                Toast.makeText(edit_tt_account_test.this, "Lỗi gì đó", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
    }
        ...
        btn_editpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (passCu.equals(pass1)) {
                    Toast.makeText(edit_tt_account_test.this, "Mật khẩu mới không được trùng với mật khẩu cũ", Toast.LENGTH_SHORT).show();
                }
                if (pass1.isEmpty() || pass2.isEmpty()) {
                    Toast.makeText(edit_tt_account_test.this, "Vui lòng không bỏ trống", Toast.LENGTH_SHORT).show();
                }
                if (pass1.length() < 5) {
                    Toast.makeText(edit_tt_account_test.this, "Vui lòng nhập mật khẩu lớn hơn 5 ký tự", Toast.LENGTH_SHORT).show();
                }
                if (!pass1.equals(pass2)) {
                    Toast.makeText(edit_tt_account_test.this, "Mật khẩu nhập lại không chính xác", Toast.LENGTH_SHORT).show();
                } else {
