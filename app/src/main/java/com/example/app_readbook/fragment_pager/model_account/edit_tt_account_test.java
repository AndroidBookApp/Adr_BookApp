...
public class edit_tt_account_test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anhdaidien = avatar.toString().trim();
...
//        String encodeImageBia = Base64.encodeToString(imageAnhBia , Base64.DEFAULT);
//        Toast.makeText(this, encodeImage, Toast.LENGTH_SHORT).show();
        ApiInterface apiInterface = ApiService.apiInterface();
//        RequestBody requestBodyId = RequestBody.create(MediaType.parse("multipart/form-data"), idmember);
